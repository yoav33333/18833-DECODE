...
object DriveHardware:SDKSubsystem() {
    ...
    val leftFront by OpModeLazyCell{SuperMotor("lf")
        .setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER)
        .setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE)
        .get()}
    val leftBack by OpModeLazyCell{SuperMotor("lr")
        .setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER)
        .setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE)
        .get()}
    val rightFront by OpModeLazyCell{SuperMotor("rf")
        .setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER)
        .setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE)
        .setDirection(DcMotorSimple.Direction.REVERSE)
        .get()}
    val rightBack by OpModeLazyCell{SuperMotor("rr")
        .setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER)
        .setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE)
        .setDirection(DcMotorSimple.Direction.REVERSE)
        .get()}
